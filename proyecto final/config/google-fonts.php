...
return [
    ...
    'fonts' => [
        ...
        'noto' => 'https://fonts.googleapis.com/css2?family=Noto+Sans:wght@900&display=swap',
        'source' => 'https://fonts.googleapis.com/css2?family=Source+Sans+Pro:wght@300&display=swap',
    ],
